<x-layout>
    ...
    <x-container>
        <div class="bg-white rounded-lg flex flex-col p-12 max-w-2xl mx-auto my-10 shadow">
            <h1 class="text-3xl font-bold mb-6">Create Collection</h1>
            <form method="POST" action="/collections/store" class="flex flex-col gap-8">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <textarea id="description" defaultValue="" value="{{ old('description') }}" name="description" type="text"
                ...
                <div class="mt-8 flex items-center justify-end gap-8">
                    ...
                    <button type="submit" class="py-2 px-5 bg-blue-600 text-white rounded shadow">Create</button>
                </div>
            </form>
    </x-container>
</x-layout>
